...
*/
/*Part 1: Week 3 - Initial Backend Setup
Note: This week’s project requirements are related to the material of Week 2 & 3.
Setup a server 
Using Mongoose, connect to a mongoDB database.
Create the following Mongoose Models:
User,Issue,Comment.
Set up the Authentication route  - ex. authRouter
Create CRUD operations:
CREATE,READ,Find One,Find All,UPDATE,DELETE
*/
