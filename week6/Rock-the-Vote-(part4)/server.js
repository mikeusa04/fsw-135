...
*/
/*Part 4: Week 6 - User Experience (UX) Improvements
Note: This week’s project requirements are related to the material of Week 5.
Frontend errors - If you haven’t yet, implement providing error messages to the User, ex. Incorrect username or password, etc.
Conditional Views - create at least one conditional view - ex. allow only logged in Users to see a logout option.
Protected routes - prevent access to URL endpoints, even if manually type in  url/endpoint, ex. localhost:3000/profile
*/
